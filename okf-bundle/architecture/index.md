...
* [Search scoring](search-scoring.md) - How search_concepts scores hits: field weights, two-pass keyword matching, phrase bonus, the relative relevance cutoff, section-level match reporting, and read coverage.
